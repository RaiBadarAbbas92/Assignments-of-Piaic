...
//Q:3 
const quote: string = "Speak good or remain silent."
;
const author: string = "Hazrat Muhammad SAW";
...
console.log(`"${quote}" - ${author}`);
 ...
 let famous_person:string="Hazrat Muhammad Saw";
 let quotes:string="Kindness is a mark of faith, and whoever is not kind has no faith.";
...
var names:string[]=["Badar","Abbas","Ali","Zaid"]
...
let transportation: string[] = ["Honda motorcycle", "Tesla Model S", "Boeing 747", "Yamaha YZF-R1", "Toyota Prius"];
...
let guests: string[] = ["QUAID E AZAM", "ILLAMA IQBAL", "IMRAN KHAN"];
...
let replacement: string = "Quaid e azam";
...
let locations:string[]=["Makkah","Masjid e Iqsa","Masjid e Nabwi","Faisal Mosque","Madina"]
...
let animal:string[]=["dog","cat","lion","cat"]
...
type biodata={Name:string,age:number,adrass:string}
...
let singer:string=`Arjit singh`
if (singer==`Arjit singh`) {
  console.log(true);
  
}
let cricketer:string=`Babar azam`
if (cricketer==`Riawan`) {
  console.log(false);  
}
let politiction:string="Imran Khan"
...
let cities:string="Lahor"
if(cities==`lahore`){console.log(true);
}
let plant:string="Mango"
if(plant==`Banana`){console.log(false);
}
let hotle:string=`5star`
if(hotle==`2star`){console.log(false);
}
...
//Q:24Alien Colors #1: Imagine an alien was just shot down in a game. Create a variable called alien_color and assign it a value of 'green', 'yellow', or 'red'.
...
//Q:25 Alien Colors #2: Choose a color for an alien as you did in Exercise 25
// Choose a color for an alien as you did in Exercise 25, and write an if-else chain.
const alienColor0: string = "red";
...
const alienColor6: string = "green";
...
const alienColor7: string = "yellow";
...
//Q:27 Write an if-else chain that determines a person’s stage of life. Set a value for the variable age, and then:
...
//Q28 Make a array of your favorite fruits, and then write a series of independent if statements that check for certain fruits in your array.
//Make a array of your three favorite fruits and call it favorite_fruits.

var favoritefruite:string[]=[`mangon`,`banana`,`watermalon`]
